...
<html>
 ...
 <script type="text/javascript" src="js/xunjian/module2/enter.js"></script>
<body>
...
<ul class="forminfo">
    <form action="receiptPTask.action" method="post" onsubmit="return reCheck()">
   <table class="tablelist">
        <tr>
             <td>  ${pTask.line.li_name}
                <ol class="forminfo">
                	<select  id="selectPole">
                	<c:forEach items="${pTask.pfpList }" var="pfp">
               			<option value="${pfp.pf_id}">${pfp.pole_code}</option>
              	  </c:forEach>
                	</select>
                 </ol>
             </td>
		   ...
		   <tr><td colspan="3">
		   <input type="button" value="上传回执" id="uploadTask" class="scbtn">
...
<table>
	   ...
	   3.所有杆塔信息录入完成后,点击上传回执,保存该线路回执录入</font>
</html>
