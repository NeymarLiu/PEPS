...
<html>
  <head>
	...
	<script type="text/javascript" src="js/xiaoque/module2/update.js"></script>
	...
	<input id="eid" type="hidden" value="${edp.e_id }">
		...
		<div class="content">
			...
			<div class="content">
				...
				<div class="div_td2"><input style="width:200px;height: 35px;" id="e_task_finish_time" name="e_task_finish_time" readonly="readonly" value="${edp.task_finish_time }"/></div>
...
<table class="tablelist" >
    	...
    	<c:forEach items="${etpList }" var="etp">	
		 ...
		 <center>
		 <input class="scbtn1" id="buttonTwo" type="button" value="保存"/>
